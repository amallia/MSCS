...
class T_VIEW_EXPORT elgamal_elgamalView : public TActionView
{
  Q_OBJECT
public:
  elgamal_elgamalView() : TActionView() { }
  QString toString();
};

QString elgamal_elgamalView::toString()
{
...
T_DEFINE_VIEW(elgamal_elgamalView)

#include "elgamal_elgamalView.moc"
