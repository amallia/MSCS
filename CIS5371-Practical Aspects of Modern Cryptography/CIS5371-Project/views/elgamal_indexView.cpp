...
class T_VIEW_EXPORT elgamal_indexView : public TActionView
{
  Q_OBJECT
public:
  elgamal_indexView() : TActionView() { }
  QString toString();
};

QString elgamal_indexView::toString()
{
...
T_DEFINE_VIEW(elgamal_indexView)

#include "elgamal_indexView.moc"
