...
class T_VIEW_EXPORT des_indexView : public TActionView
{
  Q_OBJECT
public:
  des_indexView() : TActionView() { }
  QString toString();
};

QString des_indexView::toString()
{
...
T_DEFINE_VIEW(des_indexView)

#include "des_indexView.moc"
