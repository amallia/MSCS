...
class T_VIEW_EXPORT tripleDES_indexView : public TActionView
{
  Q_OBJECT
public:
  tripleDES_indexView() : TActionView() { }
  QString toString();
};

QString tripleDES_indexView::toString()
{
...
T_DEFINE_VIEW(tripleDES_indexView)

#include "tripleDES_indexView.moc"
